...
open class UserInfo: NSObject {
    ...
    public var photo: String? {
        raw?["photo"] as? String ?? raw?["picture"] as? String
    }

    @objc
    public var nickname: String? {
        raw?["nickname"] as? String ?? raw?["nickname"] as? String
    }

    @objc
    public var name: String? {
        raw?["name"] as? String ?? raw?["name"] as? String
    }

    @objc
    public var createdAt: String? {
        raw?["createdAt"] as? String ?? raw?["createdAt"] as? String
    }

    @objc
    public var birthdate: String? {
        raw?["birthdate"] as? String ?? raw?["birthdate"] as? String
    }

    @objc
    public var address: String? {
        raw?["address"] as? String ?? raw?["address"] as? String
    }

    @objc
    public var gender: String? {
        raw?["gender"] as? String ?? raw?["gender"] as? String
    }

    @objc
    public var company: String? {
        raw?["company"] as? String ?? raw?["company"] as? String
    }

    @objc
    public var userPoolId: String? {
        raw?["userPoolId"] as? String ?? raw?["userPoolId"] as? String
    }

    @objc public var token: String?
    @objc
    public var idToken: String? {
        raw?["id_token"] as? String ?? token
    }
    ...
    public var accessTokenId: String? {
        if let at = raw?["access_token"] as? String {
            return getAccessTokenId(accessToken: at)
        }
        return nil
    }
    ...
    public var mfaToken: String? {
        mfaData?["mfaToken"] as? String
    }

    @objc
    public var mfaPhone: String? {
        mfaData?["mfaPhone"] as? String
    }

    @objc
    public var mfaEmail: String? {
        mfaData?["mfaEmail"] as? String
    }
    ...
    @objc public var firstTimeLoginToken: String?
    ...
    public func getAccessTokenId(accessToken: String) -> String? {
        ...
        if remainder > 0 {
            st = strArr[1].padding(
                toLength: strArr[1].count + 4 - remainder,
                withPad: "=",
                startingAt: 0
            )
        }
